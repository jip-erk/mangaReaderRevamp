...
// toggle quick settings menu in chapter
document.querySelectorAll(".quick-settings").forEach((div) => {
    div.addEventListener("click", (evt) => {
        if (!evt.composedPath().includes(document.querySelector(".quick-sel"))) {
            document.querySelector("html").classList.toggle("overlay-visible");
            document
                .querySelector(".quick-set")
                .classList.toggle("visible");
            document
                .querySelector(".quick-set")
                .scrollIntoView({
